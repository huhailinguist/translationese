...
This is for Chinese only. We compute TTR based on characters, rather than words.
"""
...
class LexicalVarietyQuantifier:
    ...
    def __init__(self, analysis):
        ...
        self.num_tokens = len(analysis.chars())
        self.num_types = len(analysis.chars_set())
        self.num_unique_tokens = len(self.unique_chars())
